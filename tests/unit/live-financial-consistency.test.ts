...
const sourceObservations = [
  { source: 'PDDEINFO', collectionStatus: 'COMPLETE', collectedAt: '2026-08-18T13:00:00-03:00', observationBasis: 'QUERY_TIMESTAMP', observedThrough: null, observedLagDays: null, freshnessConclusion: 'NOT_INFERRED', metrics: { schoolsCollected: 1, failures: 0 } },
  { source: 'SIGEF_EXTRATO', collectionStatus: 'COMPLETE', collectedAt: '2026-08-18T13:01:00-03:00', observationBasis: 'LATEST_MOVEMENT_RETURNED', observedThrough: '2026-08-18', observedLagDays: 0, freshnessConclusion: 'NOT_INFERRED', metrics: { accountsQueried: 1, accountsComplete: 1, accountsPartial: 0, accountsFailed: 0, movementsInFiscalYear: 1 } },
  { source: 'SIGEF_LIBERACOES', collectionStatus: 'COMPLETE', collectedAt: '2026-08-18T13:01:00-03:00', observationBasis: 'LATEST_RELEASE_RETURNED', observedThrough: '2026-08-05', observedLagDays: 13, freshnessConclusion: 'NOT_INFERRED', metrics: { queriesAttempted: 1, queriesSucceeded: 1, queriesFailed: 0, releaseRows: 1, releaseMatches: 1, recoveredAccounts: 1, confirmedAccounts: 0, accountMismatches: 0, ambiguousMatches: 0, notFound: 0, errors: 0 } },
];
function rawFixture(temporal: unknown): any {
  return {
    version: 2, generatedAt: '2026-08-18T13:01:00-03:00', fiscalYear: 2026, status: 'COMPLETE',
    sources: ['PDDEINFO', 'SIGEF_EXTRATO', 'SIGEF_LIBERACOES'], sourceObservations: structuredClone(sourceObservations),
    quality: { paymentTemporalCoverage: temporal }, coverage: { paymentTemporalCoverage: temporal }, summary: {},
    schools: [{
