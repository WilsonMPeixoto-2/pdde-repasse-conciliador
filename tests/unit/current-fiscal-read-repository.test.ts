...
const snapshotRows: Row[] = [{
  ...
  metrics: {
    ...
    accounts: 284,
    movements: 394,
    programmedCents: 218_205_000,
    paidInformedCents: 82_761_500,
    creditedCents: 40_901_000,
    reportedBalanceCents: 164_201_997,
  },
}];
const schoolRows: Row[] = [{
  ...
  metrics: {
    accounts: 2,
    movements: 4,
    programmedCents: 30_000,
    paidInformedCents: 15_000,
    creditedCents: 15_000,
    reportedBalanceCents: 15_000,
  },
  snapshot: {
    fiscalYear: 2026,
